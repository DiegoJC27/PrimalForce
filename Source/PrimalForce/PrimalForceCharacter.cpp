...
#include "PrimalForce.h"

APrimalForceCharacter::APrimalForceCharacter()
{
...
void APrimalForceCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APrimalForceCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &APrimalForceCharacter::Look);
...
void APrimalForceCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
